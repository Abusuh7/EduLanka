<x-app-layout>
    ...
    <div class="container mx-auto p-4">
        ...
        <div class="mb-4">
            ...
            <select name="class_id" id="class_id" class="block w-full p-1.5 mt-1 border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-200 focus:outline-none sm:text-sm">
        ...
        <div class="mb-4">
            ...
            <select name="grade_id" id="grade_id" class="block w-full p-1.5 mt-1 border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-200 focus:outline-none sm:text-sm">
