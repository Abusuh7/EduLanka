<x-app-layout>
    ...
    <div class="max-w-md mx-auto mt-8 p-6 border border-gray-300 rounded-lg shadow-md hidden" id="discussionRoom1form">
        <div class="flex justify-end">
            <button type="button" class="text-gray-600 hover:text-gray-800 transition duration-300 focus:outline-none" id="closeDiscussionForm1">
    ...
    <div class="max-w-md mx-auto mt-8 p-6 border border-gray-300 rounded-lg shadow-md hidden" id="discussionRoom2form">
        <div class="flex justify-end">
            <button type="button" class="text-gray-600 hover:text-gray-800 transition duration-300 focus:outline-none" id="closeDiscussionForm2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd"
                        d="M4.293 5.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                        clip-rule="evenodd" />
        ...
        <form action="" method="POST" class="mt-6">
            ...
            <div>
                <label for="room_name" class="block text-sm font-medium text-gray-700">Room Name</label>
                <input type="text" name="room_name" id="room_name" autocomplete="room_name" value="Room 2" readonly
                    class="mt-1 focus:ring-primary-500 focus:border-primary-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>

            <div class="mt-6">
                <label for="capacity" class="block text-sm font-medium text-gray-700">Capacity</label>
                <input type="text" name="capacity" id="capacity" autocomplete="capacity" value="5" readonly
                    class="mt-1 focus:ring-primary-500 focus:border-primary-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>
    ...
    <div class="max-w-md mx-auto mt-8 p-6 border border-gray-300 rounded-lg shadow-md hidden" id="discussionRoom3form">
        <div class="flex justify-end">
            <button type="button" class="text-gray-600 hover:text-gray-800 transition duration-300 focus:outline-none" id="closeDiscussionForm3">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd"
                        d="M4.293 5.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                        clip-rule="evenodd" />
        ...
        <form action="" method="POST" class="mt-6">
            ...
            <div>
                <label for="room_name" class="block text-sm font-medium text-gray-700">Room Name</label>
                <input type="text" name="room_name" id="room_name" autocomplete="room_name" value="Room 3" readonly
                    class="mt-1 focus:ring-primary-500 focus:border-primary-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>

            <div class="mt-6">
                <label for="capacity" class="block text-sm font-medium text-gray-700">Capacity</label>
                <input type="text" name="capacity" id="capacity" autocomplete="capacity" value="3" readonly
                    class="mt-1 focus:ring-primary-500 focus:border-primary-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>
